...
<div class="frame">
	...
	<div class="productAdd_form">
		<form method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
			<p><input type="text" name="gijang_SaleBoard_Title" placeholder="제목" required autofocus></p>
			<p><input type="number" name="gijang_SaleBoard_Price" placeholder="가격" required></p>
			...
			<p><input id="gijang_SaleBoard_Type" type="text" name="gijang_SaleBoard_Type" readonly="readonly"></p>
